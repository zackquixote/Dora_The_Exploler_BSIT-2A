<?php
// This view expects:
// $certificates - array of certificate arrays from CertificateModel::getCertificateForPrint()
// $contents     - array of template HTML with placeholders already replaced, keyed by certificate ID
// $settings     - barangay settings array
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<div class="print-toolbar">
    <a href="<?= base_url('certificate') ?>" class="back-btn">← Back to Log</a>
    <button onclick="window.print()" class="print-btn">🖨️ Print All</button>
</div>
