...
// FIXED: Routes updated to point to 'HouseholdController' in root Controllers folder
 ...
 $routes->get('households/getNextHouseholdNo', 'HouseholdController::getNextHouseholdNo');
 $routes->get('households/checkHouseholdNo', 'HouseholdController::checkHouseholdNo');
